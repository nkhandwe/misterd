export const english = {
  ...
  "After completing the order, you will receive a":
    "After completing the order, you will receive a",
  "Welcome to Misterd!": "Welcome to Misterd!",
  ...
  "Register as seller and open shop in Misterd to start your business":
    "Register as seller and open shop in Misterd to start your business",
  ...
  eBusiness: "eBusiness",
  Solution: "Solution",
  "Misterd is a Laravel and Flutter Framework-based multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system. It has six modules to cover all your business functionality.":
    "Misterd is a Laravel and Flutter Framework-based multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system. It has six modules to cover all your business functionality.",
  ...
  "You made your earning when the order is complete":
    "You made your earning when the order is complete",
  "They create a account on Misterd using your code and place their first order":
    "They create a account on Misterd using your code and place their first order",
